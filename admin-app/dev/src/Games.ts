...
interface IGame { title: string, description: string, instructions: string, iframe: string, link: string, assets: string, mobile: boolean, categories: string, tags: string, res: boolean }

export const GetGame = async (uri: string, creds: string): Promise<IGame | { res: boolean; msg: any; }> => {
...
const getGamePromise = async (): Promise<IGame> => {
	try {
